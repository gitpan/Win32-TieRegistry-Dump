# This Makefile is for the Win32::TieRegistry::Dump extension to perl.
#
...
#	ABSTRACT_FROM => q[Dump.pm]
#	AUTHOR => q[Lee Goddard <lgoddard@cpan.org>]
#	NAME => q[Win32::TieRegistry::Dump]
#	PREREQ_PM => { Win32::TieRegistry=>q[0.2] }
#	VERSION_FROM => q[Dump.pm]
...
# These definitions are from config.sh (via C:\Lang\Perl\lib/Config.pm)
...
AR_STATIC_ARGS = cr
NAME = Win32::TieRegistry::Dump
DISTNAME = Win32-TieRegistry-Dump
NAME_SYM = Win32_TieRegistry_Dump
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib\bin
...
INSTALLSITELIB = C:\Lang\Perl\site\lib
INSTALLSITEARCH = C:\Lang\Perl\site\lib
INSTALLBIN = $(PREFIX)\bin
INSTALLSCRIPT = $(PREFIX)\bin
PERL_LIB = C:\Lang\Perl\lib
PERL_ARCHLIB = C:\Lang\Perl\lib
SITELIBEXP = C:\Lang\Perl\site\lib
SITEARCHEXP = C:\Lang\Perl\site\lib
LIBPERL_A = libperl.lib
FIRST_MAKEFILE = Makefile
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = C:\Lang\Perl\lib\CORE
PERL = C:\Lang\Perl\bin\perl.exe
FULLPERL = C:\Lang\Perl\bin\perl.exe
...
FULLEXT = Win32\TieRegistry\Dump
BASEEXT = Dump
PARENT_NAME = Win32::TieRegistry
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)\Win32\TieRegistry
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Win32\TieRegistry
...
$(INST_AUTODIR)\.exists :: C:\Lang\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_AUTODIR)
	@$(EQUALIZE_TIMESTAMP) C:\Lang\Perl\lib\CORE\perl.h $(INST_AUTODIR)\.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_AUTODIR)

$(INST_LIBDIR)\.exists :: C:\Lang\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_LIBDIR)
	@$(EQUALIZE_TIMESTAMP) C:\Lang\Perl\lib\CORE\perl.h $(INST_LIBDIR)\.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_LIBDIR)

$(INST_ARCHAUTODIR)\.exists :: C:\Lang\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_ARCHAUTODIR)
	@$(EQUALIZE_TIMESTAMP) C:\Lang\Perl\lib\CORE\perl.h $(INST_ARCHAUTODIR)\.exists
...
Dump.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Win32::TieRegistry::Dump', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIBDIR)\Dump.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Win32-TieRegistry-Dump\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Win32-TieRegistry-Dump</TITLE>\n}. qq{\t<ABSTRACT>dump Win32 registry tree</ABSTRACT>\n}. qq{\t<AUTHOR>Lee Goddard &lt;lgoddard\@cpan.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Win32-TieRegistry\" VERSION=\"0,2,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Win32-TieRegistry-Dump.ppd
